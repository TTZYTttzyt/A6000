...
from omni.isaac.orbit_tasks.manipulation.cabinetCam import mdp
from omni.isaac.orbit_tasks.manipulation.cabinetCam.cabinet_env_cfg import CabinetEnvCfg,MobilityEnvCfg

##
# Pre-defined configs
##
from omni.isaac.orbit_assets.franka import FRANKA_PANDA_CFG  # isort: skip
from omni.isaac.orbit_tasks.manipulation.cabinetCam.cabinet_env_cfg import FRAME_MARKER_SMALL_CFG  # isort: skip
...
@configclass
class FrankaMobilityEnvCfg(MobilityEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class FrankaCabinetEnvCfgRGB(CabinetEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
