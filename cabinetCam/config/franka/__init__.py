...
gym.register(
    id="Isaac-Open-Mobility-Franka-v0",
    entry_point="omni.isaac.orbit.envs:RLTaskEnv",
    kwargs={
        "env_cfg_entry_point": joint_pos_env_cfg.FrankaMobilityEnvCfg,
        "rsl_rl_cfg_entry_point": agents.rsl_rl_cfg.MobilityPPORunnerCfg,
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_ppo_cfg.yaml",
    },
    disable_env_checker=True,
)
